             ...
             <div className="grid grid-cols-3 gap-2">
               {faces.map((face) => (
                 <button
                   ...
                   className={\`px-3 py-2 text-xs md:text-sm font-medium rounded-md transition-all border \${
                     selectedTab === face 
               ...
               <button
                 ...
                 className={\`col-span-3 px-3 py-2 text-xs md:text-sm font-medium rounded-md transition-all border flex items-center justify-center gap-1 \${
